...
class TestDataTypes(object):
    def setup(self):
        ...
        self.header = dt.Header("123456789", "123456789", "A", "YOUR BANK", "YOUR COMPANY")
    ...
    def test_invalid_property_header(self):
        ...
        """
        nt.assert_raises(dt.AchError, setattr, self.header, "test_property", "testtesttest")
        nt.assert_raises(dt.AchError, setattr, self.file_control, "test_property", "testtesttest")
        nt.assert_raises(dt.AchError, setattr, self.batch_header, "test_property", "testtesttest")
        nt.assert_raises(dt.AchError, setattr, self.batch_control, "test_property", "testtesttest")
        nt.assert_raises(dt.AchError, setattr, self.entry_detail, "test_property", "testtesttest")
        nt.assert_raises(dt.AchError, setattr, self.addenda_record, "test_property", "testtesttest")
    ...
    def test_check_digit(self):
        ...
        nt.assert_equal(self.entry_detail.recv_dfi_id + self.entry_detail.check_digit, "111000025")
